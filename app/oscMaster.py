...
class oscMaster:
    def __init__(self,  cfg:dict):
        ...
        # self.bp_mod = BargerPropagator.PyBargerPropagator(f'{self._outdir}/FULL_PREM.dat')
        self.set_Earth_model(None, None)
        #self._earth = EarthModel(cfg, None, None)
    ...
    def set_Earth_model(self, change_type, change_value):
        self._earth = EarthModel(self._cfg, change_type, change_value)
        self._earth .optimize()
